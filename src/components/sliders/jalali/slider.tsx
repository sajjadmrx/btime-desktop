  ...
  return (
    <div className="flex h-screen items-center justify-center">
      <div className="flex flex-col items-center justify-center gap-4">
        <div className="select-none text-gray-600 dark:text-[#eee]">
          {currentTime.locale("fa").format("dddd")}
        </div>
        <div className="text-6xl select-none text-gray-600  dark:text-[#eee]">
          {currentTime.locale("fa").jDate()}
        </div>
        <div className="flex flex-row gap-3 text-gray-600  dark:text-[#eee]">
