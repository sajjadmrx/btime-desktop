      ...
      <div className="flex flex-col gap-3">
        <div className="flex flex-row items-center justify-between w-full gap-2">
          <div className="flex flex-col gap-2">
            ...
            <div className="text-sm text-gray-600 font-normal dark:text-[#c7c7c7]">
              این برنامه توسط جامعه متن باز ایران طراحی شده است.
            </div>
            <div className="text-sm  text-gray-600 dark:text-[#c7c7c7]">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-row h-23 w-23 not-moveable">
                <div
