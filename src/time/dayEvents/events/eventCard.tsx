...
export const EventCard = ({ event }: EventCardProps) => {
	...
	return (
		<div
			className={` rounded-lg overflow-hidden bg-white dark:bg-gray-800/60 backdrop-blur-sm border-r ${event.isHoliday ? 'border-red-500' : event.source === 'google' ? 'border-blue-500' : 'border-gray-300 dark:border-gray-600'}`}
			dir="rtl"
		>
			<div className="p-1">
